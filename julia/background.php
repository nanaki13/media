<div id="div_back" >
		<img class="image_back" src="./rsc/img/Le ruban_p_acc.jpg" alt="1"/>
		<img class="image_back" src="./rsc/img/jeanne_endormie_g_acc.jpg" alt="2"/>
		<img class="image_back" src="./rsc/img/Le_peigne_p_acc.jpg" alt="3"/>
